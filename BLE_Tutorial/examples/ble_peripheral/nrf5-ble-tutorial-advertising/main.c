...
#define DEVICE_NAME                      "Ru"                               /**< Name of device. Will be included in the advertising data. */
...
{
    uint32_t      err_code;
    ble_advdata_t advdata; // Struct containing the adversing parameters
	  
	  ble_advdata_manuf_data_t        manuf_data; // Variable to hold manufacturer Specific data
	  uint8_t data[]                 = "SomeData"; // your Data to advice
    manuf_data.company_identifier  = 0x0059; // Nordic Compagny ID
    ...
    advdata.flags                   = BLE_GAP_ADV_FLAGS_LE_ONLY_GENERAL_DISC_MODE;
	  ...
	  uint8_t tx_power                = -8; // set the tx power
	 ...
	 // prepare the scan response Manufacturer specific data packet
	  ble_advdata_manuf_data_t         manuf_data_response;
		uint8_t data_response[]           = "Many_bytes_of_data"; //remember the re is a 0 terminator at the end of string
		...
		// Always initialize all fields in structs to zero or you micht get unexpected behaviour
